...
#define TRY(...)     for(;_TRY(__VA_ARGS__);THROW())if(!1);
...
#define _CATCH_DO(...) do{ struct _EXCEPTION_DONT_EXISTS{char _;}; __VA_ARGS__ }while(!1); break; if(_5tc_->jmp) continue;
